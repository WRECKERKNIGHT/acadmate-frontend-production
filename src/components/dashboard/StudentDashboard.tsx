            ...
            >
              <GlowCard>
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-bold text-purple-400">Achievements</h3>
                        ...
                        <div className="mt-1 w-full bg-gray-700 rounded-full h-1">
                          <motion.div
                            ...
                            className={`h-1 rounded-full ${
                              achievement.earned ? 'bg-green-400' : 'bg-cyan-400'
                            }`}
                          />
                        </div>
                      </div>
              ...
              <GlowCard>
                ...
                <div className="space-y-3">
                  {[
                    { icon: BookOpen, label: 'View Assignments', color: 'cyan' },
                    { icon: Calendar, label: 'Check Schedule', color: 'purple' },
                    { icon: Activity, label: 'Performance', color: 'green' },
                    { icon: User, label: 'Profile', color: 'yellow' }
                  ].map((action, index) => (
                    <motion.button
                      key={action.label}
